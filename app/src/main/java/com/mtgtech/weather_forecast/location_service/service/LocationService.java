package com.mtgtech.weather_forecast.location_service.service;
...
public abstract class LocationService {
    ...
    NotificationChannel getLocationNotificationChannel(Context context) {
        NotificationChannel channel = new NotificationChannel(
                WeatherFlow.NOTIFICATION_CHANNEL_ID_LOCATION,
                WeatherFlow.getNotificationChannelName(
                        context, WeatherFlow.NOTIFICATION_CHANNEL_ID_LOCATION),
    ...
    Notification getLocationNotification(Context context) {
        return new NotificationCompat.Builder(context, WeatherFlow.NOTIFICATION_CHANNEL_ID_LOCATION)
