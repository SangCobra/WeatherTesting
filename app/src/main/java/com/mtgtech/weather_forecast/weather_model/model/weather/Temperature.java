...
/**
 * Temperature.
 * default unit : {@link com.mtgtech.weather_forecast.weather_model.model.option.unit.TemperatureUnit#C}
 */
public class Temperature implements Serializable {
    ...
    @Nullable
    private Integer realFeelShaderTemperature;
    @Nullable
    private Integer apparentTemperature;
    @Nullable
    private Integer windChillTemperature;
    @Nullable
    private Integer wetBulbTemperature;
    @Nullable
    private Integer degreeDayTemperature;
