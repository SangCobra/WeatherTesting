package com.mtgtech.weather_forecast.background.polling.permanent;

import android.content.Context;
import android.content.Intent;
import android.os.Build;

import com.mtgtech.weather_forecast.background.polling.permanent.observer.TimeObserverService;
