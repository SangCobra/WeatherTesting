package com.mtgtech.weather_forecast.view.adapter;
...
import com.mtgtech.weather_forecast.view.weather_widget.TagView;
...
//                WeatherFlow.adUtil().showInterstitialAd(new OnInterstitialAdListener() {
//                    @Override
//                    public void onAdListener(boolean isLoaded, @NotNull Interstitial interstitial) {
//                        if (isLoaded) {
//                            switch (interstitial) {
//                                case ON_AD_CLOSED :{
