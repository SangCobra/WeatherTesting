package com.mtgtech.weather_forecast.view.weather_widget.trend.chart;
...
import com.mtgtech.weather_forecast.view.weather_widget.DayNightShaderWrapper;
import com.mtgtech.weather_forecast.view.weather_widget.trend.abs.ChartItemView;
...
public class PolylineAndHistogramView extends ChartItemView {
    ...
    private static final float POLYLINE_SIZE_DIP = 0f;
...
//        }
    ...
    private void drawTimeLine(Canvas canvas) {
        ...
        whiteCirclePaint.setColor(ContextCompat.getColor(getContext(), R.color.colorTextWhite));

        Paint lightCirclePaint = new Paint();
        lightCirclePaint.setStyle(Paint.Style.FILL);
        lightCirclePaint.setColor(ContextCompat.getColor(getContext(), R.color.gnt_white50));
