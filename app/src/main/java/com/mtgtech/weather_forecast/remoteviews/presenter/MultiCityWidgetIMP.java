...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetMultiCityProvider;
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_MULTI_CITY_PENDING_INTENT_CODE_REFRESH_1 + 2 * index
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_MULTI_CITY_PENDING_INTENT_CODE_WEATHER_1 + 2 * index
                    )
            );
        }
    }
