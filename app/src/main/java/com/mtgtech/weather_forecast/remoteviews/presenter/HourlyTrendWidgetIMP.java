...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetTrendHourlyProvider;
import com.mtgtech.weather_forecast.remoteviews.trend.TrendLinearLayout;
import com.mtgtech.weather_forecast.remoteviews.trend.WidgetItemView;
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_TREND_HOURLY_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_TREND_HOURLY_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
    }
