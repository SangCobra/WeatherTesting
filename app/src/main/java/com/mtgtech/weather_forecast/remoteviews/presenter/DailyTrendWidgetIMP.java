...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetTrendDailyProvider;
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_TREND_DAILY_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_TREND_DAILY_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
    }
