...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetDayWeekProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location,
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
        ...
        views.setOnClickPendingIntent(
                ...
                getDailyForecastPendingIntent(
                        ...
                        location,
                        0,
                        WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_1
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_day_week_icon_2,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        1,
                        WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_2
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_day_week_icon_3,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        2,
                        WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_3
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_day_week_icon_4,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        3,
                        WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_4
                )
        );
        views.setOnClickPendingIntent(
                R.id.widget_day_week_icon_5,
                getDailyForecastPendingIntent(
                        ...
                        location,
                        4,
                        WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_5
                )
        );
        ...
        if (subtitleData.equals("lunar")) {
            views.setOnClickPendingIntent(
                    ...
                    getCalendarPendingIntent(
                            context,
                            WeatherFlow.WIDGET_DAY_WEEK_PENDING_INTENT_CODE_CALENDAR
                    )
            );
