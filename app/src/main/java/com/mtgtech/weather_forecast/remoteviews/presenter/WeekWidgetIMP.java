...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetWeekProvider;
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
        ...
        if (viewType.equals("3_days")) {
            views.setOnClickPendingIntent(
                    ...
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            0,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_1
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_2,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            1,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_2
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_3,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            2,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_3
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_4,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            3,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_4
                    )
            );
            views.setOnClickPendingIntent(
                    R.id.widget_week_icon_5,
                    getDailyForecastPendingIntent(
                            ...
                            location,
                            4,
                            WeatherFlow.WIDGET_WEEK_PENDING_INTENT_CODE_DAILY_FORECAST_5
                    )
            );
        }
    }
