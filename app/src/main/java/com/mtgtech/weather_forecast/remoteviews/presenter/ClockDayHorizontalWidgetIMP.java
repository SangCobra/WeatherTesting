...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetClockDayHorizontalProvider;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location,
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
        ...
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CLOCK_BLACK
                )
        );
        ...
        views.setOnClickPendingIntent(
                ...
                getCalendarPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_HORIZONTAL_PENDING_INTENT_CODE_CALENDAR
                )
        );
    }
}
