package com.mtgtech.weather_forecast.remoteviews.presenter;
...
import com.mtgtech.weather_forecast.background.receiver.widget.WidgetClockDayVerticalProvider;
import com.mtgtech.weather_forecast.remoteviews.WidgetUtils;
import com.mtgtech.weather_forecast.resource.ResourceHelper;
...
import com.mtgtech.weather_forecast.utils.helpter.LunarHelper;
    ...
    private static void setOnClickPendingIntent(Context context, RemoteViews views, Location location,
        ...
        if (touchToRefresh) {
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_REFRESH
                    )
            );
        } else {
            views.setOnClickPendingIntent(
                    ...
                    getWeatherPendingIntent(
                            context,
                            location,
                            WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_WEATHER
                    )
            );
        }
        ...
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_BLACK
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_1_BLACK
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_LIGHT
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_NORMAL
                )
        );
        views.setOnClickPendingIntent(
                ...
                getAlarmPendingIntent(
                        context,
                        WeatherFlow.WIDGET_CLOCK_DAY_VERTICAL_PENDING_INTENT_CODE_CLOCK_2_BLACK
                )
        );
        ...
        if (subtitleData.equals("lunar")) {
            views.setOnClickPendingIntent(
                    ...
                    getCalendarPendingIntent(
                            context,
                            WeatherFlow.WIDGET_DAY_PENDING_INTENT_CODE_CALENDAR
                    )
            );
            ...
            views.setOnClickPendingIntent(
                    ...
                    getRefreshPendingIntent(
                            context,
                            WeatherFlow.WIDGET_DAY_PENDING_INTENT_CODE_REFRESH
                    )
            );
        }
    }
