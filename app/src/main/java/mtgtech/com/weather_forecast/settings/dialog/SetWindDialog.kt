...
class SetWindDialog(contentLayoutId: Int = R.layout.dialog_setting_windpeed) : AppCompatActivity(contentLayoutId) {
    companion object{
    ...
    private var settingsOptionManager : SettingsOptionManager = SettingsOptionManager.getInstance(this)
